...
namespace Workwise.Persistance.DAL.Migrations
{
    ...
    [Migration("20240821232603_AddSignalR")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Workwise.Domain.Entities.Chat", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Workwise.Domain.Entities.Message", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Workwise.Domain.Entities.Notification", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Workwise.Domain.Entities.Chat", b =>
                {
                    b.HasOne("Workwise.Domain.Entities.AppUser", "AppUser1")
                        .WithMany("Chats")
                        .HasForeignKey("AppUser1Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Workwise.Domain.Entities.AppUser", "AppUser2")
                        .WithMany()
            ...
            modelBuilder.Entity("Workwise.Domain.Entities.Message", b =>
                {
                    ...
                    b.HasOne("Workwise.Domain.Entities.Chat", "Chat")
                        .WithMany("Messages")
