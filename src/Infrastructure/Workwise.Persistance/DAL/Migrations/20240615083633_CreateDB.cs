        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BanerUrl = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    BehanceLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    YoutubeLink = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    IsOnlinne = table.Column<bool>(type: "bit", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    School_University = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_HireAccounts", x => x.Id);
                    table.ForeignKey(
                        name: "FK_HireAccounts_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobLike", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobLike_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ProjectLikes_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    JobCommentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_JobReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_JobReplies_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReplyComment = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    AppUserId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    ProjectCommentId = table.Column<string>(type: "nvarchar(450)", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CreateAt = table.Column<DateTime>(type: "datetime2", nullable: false),
                    UpdateAt = table.Column<DateTime>(type: "datetime2", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProjectReplies", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProjectReplies_AspNetUsers_AppUserId",
                        column: x => x.AppUserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_JobLike_AppUserId",
                table: "JobLike",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_JobLike_JobId",
                table: "JobLike",
                column: "JobId");

            migrationBuilder.CreateIndex(
                name: "IX_JobReplies_AppUserId",
                table: "JobReplies",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_JobReplies_JobCommentId",
                table: "JobReplies",
                column: "JobCommentId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectComments_AppUserId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectLikes_AppUserId",
                table: "ProjectLikes",
                column: "AppUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProjectReplies_AppUserId",
                table: "ProjectReplies",
                column: "AppUserId");

            migrationBuilder.CreateIndex(
                name: "IX_ProjectReplies_ProjectCommentId",
                table: "ProjectReplies",
